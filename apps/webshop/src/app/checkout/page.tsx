...
export default function CheckoutPage() {
  ...
  // Onclick handler for the checkout button
        ...
        <div className="text-center max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="space-y-4">
            ...
            <p className="font-body text-secondary leading-relaxed">
              Before you can proceed to checkout, you'll need to add some
    ...
    <div className="min-h-screen pt-32 pb-20 bg-background">
      <div className="max-w-screen-2xl mx-auto px-8">
        <header className="mb-16 animate-in fade-in slide-in-from-left-4 duration-700">
          ...
          <h1 className="text-5xl font-headline italic text-primary">
            Finalizing Your Order
          </h1>
          <p className="font-body text-secondary mt-4">
            Review your selected items and proceed to secure payment.
          </p>
        </header>
                    ...
                    <div className="flex flex-1 flex-col py-2">
                      <div className="flex justify-between items-start gap-4">
                        <div className="space-y-2">
                          ...
                          <p className="font-body text-lg italic text-secondary">
                            {item.author.name}
                          </p>
                        </div>
            ...
            <div className="sticky top-40 space-y-8 animate-in fade-in slide-in-from-right-4 duration-700">
              <div className="bg-surface-container-lowest border border-primary/10 p-10 shadow-sm relative overflow-hidden">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-between items-center text-secondary border-b border-primary/5 pb-6">
                    <div className="flex flex-col">
                      ...
                      <span className="text-[10px] italic text-secondary/60 mt-1">
                  ...
                  <div className="flex justify-between items-baseline pt-4">
                    ...
                    <span className="text-3xl font-headline text-primary font-bold">
                ...
                <div className="mt-10 space-y-4">
                  <button
                    ...
                    disabled={loading}
                    className="w-full bg-primary text-on-primary py-5 font-label font-bold uppercase tracking-[0.25em] hover:bg-primary/95 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    <CreditCard className="w-5 h-5" />
                    {loading ? "Redirecting..." : "Proceed to Payment"}
                  </button>
                  <p className="text-center font-label text-[10px] text-secondary/70 italic max-w-70 mx-auto leading-relaxed">
                    You will be redirected to{" "}
                    <span className="font-bold text-primary not-italic">
                      Stripe
                    </span>{" "}
                    for a secure payment experience. Shipping and billing
                    address details will be collected there.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-surface-container-low p-6 flex flex-col items-center text-center space-y-3 border border-primary/5 shadow-sm">
                  ...
                  <p className="font-label text-[9px] uppercase tracking-widest text-secondary">
