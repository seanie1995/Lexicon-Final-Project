...
// Metadata for the registration success page
export const metadata: Metadata = {
	title: "Account Created | The Digital Archivist",
		...
		>
			<div className="w-full max-w-md mx-auto">
				<div className="bg-surface-container-lowest p-8 md:p-12 border border-outline-variant">
					...
					{/* Icon is decorative — the heading already explains the context */}
					...
					{/* id matches aria-labelled by on main — screen readers announce this as the page title */}
					<h1
						id="success-heading"
						className="text-2xl font-serif text-primary text-center mb-4"
					>
						Check Your Email
					</h1>
					...
					{/* role="note" marks this as supplementary information */}
					<div
						role="note"
						className="bg-surface-container-low p-4 border border-outline/20 mb-8"
					>
