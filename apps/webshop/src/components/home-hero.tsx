...
const HomeHero = () => {
    return (
        <section className="relative overflow-hidden bg-surface px-6 py-24 lg:px-20">
            <div className="mx-auto flex max-w-screen-2xl flex-col gap-16 lg:flex-row lg:items-center">
                {/* ── Text block ── */}
                <div className="z-10 max-w-2xl flex-1 space-y-8">
                    <header className="space-y-4">
                        ...
                        <h1 className="font-headline text-5xl font-black leading-[1.1] tracking-tight text-on-surface lg:text-7xl">
                            Preserving the{" "}
                            <span className="font-serif italic font-normal">Soul</span> of
                            the Written Word
                        </h1>
                    ...
                    <nav className="flex flex-wrap gap-6 pt-4" aria-label="Hero actions">
                        ...
                        <Link
                            href="/appraisal"
                            className="bg-surface-container-high px-10 py-5 font-label text-xs uppercase tracking-widest text-on-surface-variant transition-all hover:bg-surface-container-highest"
                        >
                            Request Appraisal
                        </Link>
                    </nav>
