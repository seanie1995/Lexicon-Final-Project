	...
	return (
		<div className="w-full max-w-md mx-auto">
			<div className="bg-surface-container-lowest p-8 md:p-12 border border-outline-variant/10 shadow-2xl">
				...
				{/* aria-label gives the form a name for screen readers */}
				<form
				...
				{/* aria-hidden — the OR divider is decorative, no need to read it */}
				...
				>
					{/* aria-hidden — button's aria-label already describes this */}
					<svg
						className="h-5 w-5"
						viewBox="0 0 24 24"
						aria-hidden="true"
